...
### Weekly Recap 
As mentioned last week, a remnant Gulf Stream ring is affecting shelfedge conditions.  As depicted by one of the green worms in the animation below, it took one of the drifters (prepared by CSCR & Scituate High School students) for a wild ride. You can also see one of Cassie’s miniboats (red worm) enter the scene on Halloween morning and eMOLT bottom temps (white #s) pop up here and there.
