...
Several of the original eMOLT participants regularly supplied lobster haul data associated with their temperature data. Therese Sauvageau out of Beverly Mass, for example, still submits here records each year so that we MIGHT someday be able to determine the correlation (if any) between catch and temperature.  As seen in the figure below, she also recorded the surface temperature as measured by her hull-mounted thermistor. While we do not expect it to be highly accurate, it does provide an index of stratification (ie difference bewteen surface and bottom temperatures). As usual, it is difficult to detect any obvious relationships, we can see that it may be a function of the variability rather than the absolute value of temperature.
