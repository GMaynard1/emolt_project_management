...
urls.append('https://tds.marine.rutgers.edu/thredds/ncss/roms/doppio/2017_da/his/History_Best?var=temp&disableLLSubset=on&disableProjSubset=on&horizStride=1&time_start=' + sdaystri + '&time_end=2023-08-10T00%3A00%3A00Z&timeStride=1&vertCoord=-0.9875&accept=netcdf')
    ...
    files.append(r'/home/george/Documents/Plotting/DOPPIO/forecast/data/DOPPIO_'+daystri3+'.nc')
