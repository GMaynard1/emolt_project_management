...
data=read.csv(
  paste0(
    ...
    "T11%3A59%3A59Z&latitude%3C=41.5&longitude%3C=-67"
  )
)
...
full_data=read.csv(
  paste0(
    ...
    "T23%3A59%3A59Z&latitude%3C=41.5&longitude%3C=-67"
  )
)
...
tows=c(41376,41364,41360,41348,41335,41331,41447,41479)
tow_col=c('brown','black','orange','purple','green','gold1','firebrick2','blue','hotpink','aquamarine')
## Set up plot
par(mfrow=c(1,2))
plot(
  bath,
