...
) COMMENT='This table is columns 1-4, 6, 27, and 30 from FVTR.FVTR_GEAR_CODES@sole. It contains both human readable and standard codes for all gear types categorized by ACCSP and NEFSC. It also includes values from the International Standard Statistical Classification of Fishing Gears (ISSCFG)'; 