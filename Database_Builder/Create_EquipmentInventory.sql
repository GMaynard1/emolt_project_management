CREATE TABLE `EQUIPMENT_INVENTORY` (
  ...
  `CURRENT_LOCATION` set('HOME','LAB','VESSEL','MANUFACTURER') NOT NULL COMMENT 'Where the equipment is currently located',
  `CUSTODIAN` integer NOT NULL COMMENT 'Contact of person who has possession of the equipment',
