## CREATE A WAY TO ADD EQUIPMENT RECORDS WITHOUT ENTERING A NEW VISIT
## LOGIN FUNCTION
## MODULARIZE THE CODE
library(shiny)
library(RMySQL)
      ...
      shinyalert(
        ...
        callbackR=function(x){
          if(x!=FALSE){
            ...
            ## INSERT THE EQUIPMENT CHANGE RECORD
            statement=paste0(
